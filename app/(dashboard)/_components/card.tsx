  ...
  return (
    <div className="max-w-4xl mx-auto p-4 bg-white shadow-md rounded-lg flex items-center space-x-4 my-5">
      <div className="w-24 h-24 relative">
        <Image src={imageUrl || 'http://res.cloudinary.com/digrp0u1f/image/upload/v1717363067/ozgxxvanrv7py3gqcxk0.webp'} alt={title} layout="fill" objectFit="cover" className="rounded-lg" />
      </div>
