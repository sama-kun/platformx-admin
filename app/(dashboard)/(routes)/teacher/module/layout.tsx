...
const ModuleLayout = ({
    ...
    return (
        <div className='flex'>
            <div className="flex flex-col w-64 h-screen bg-white text-black fixed overflow-y-auto shadow-lg">
                ...
                <div className="flex flex-col flex-1 overflow-y-auto">
                    <nav className="flex flex-col p-4 space-y-4">
                        <Link
                            ...
                            className={`flex items-center space-x-3 p-2 rounded-md ${isActive ? 'bg-black text-white' : 'hover:bg-gray-200'}`}
                        >
                            <span>About Module</span>
                        </Link>
                        <span className="text-xl font-bold mt-4">Subjects</span>
                    ...
                    <nav className="flex flex-col p-4 space-y-4">
                        <span className="text-xl font-bold mt-4">Tasks</span>
            ...
            <main className='ml-64 pt-20 px-4 w-full'>
                {children}
            </main>
        </div>
    );
